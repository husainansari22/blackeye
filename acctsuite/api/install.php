...
/**
 * One-time installer: open https://acctsuite.com/api/install.php
...
<head>
  ...
  <title>AcctSuite API Install</title>
  <style>
    ...
    a{color:#E04A28} code{background:#f1f5f9;padding:2px 6px;border-radius:6px}
  </style>
</head>
<body>
  <div class="card">
    <h1>AcctSuite Backend Install</h1>
    <?php if ($done): ?>
