...
(function (global) {
  ...
  function ensureToastStyles() {
    ...
    style.textContent =
      '#acctsuiteStaffToast{position:fixed;left:50%;bottom:24px;transform:translateX(-50%) translateY(120%);z-index:99999;max-width:min(92vw,380px);background:#0f172a;color:#fff;border:1px solid #0ea5e9;border-radius:14px;padding:12px 14px;box-shadow:0 12px 40px rgba(0,0,0,.35);transition:transform .25s ease;font-family:system-ui,sans-serif}' +
